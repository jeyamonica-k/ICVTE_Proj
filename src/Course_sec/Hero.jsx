            ...
            <>
              <div className="flex flex-col shadow-2xl lg:flex-row ">
                ...
                <div className="p-1 flex flex-col md:p-3  lg:w-[60%] ">
                  ...
                  <button className="p-2 m-2 w-fit font-medium text-red-600 border-2 border-black hover:bg-red-600 hover:text-black hover:border-none cursor-pointer md:text-2xl">
                    Read More
                  </button>
                </div>
              </div>
