  ...
  <>
    <div className="flex flex-col m-1 gap-2 border-t-2 border-blue-950 rounded-t-3xl p-4 md:flex-row md:m-7  md:justify-around">
      ...
      <div className="flex flex-col gap-3 md:hidden">
        <h1 className="text-red-600 font-bold  border-t-2 hover:cursor-pointer border-transparent p-1 hover:border-b-blue-900">Courses</h1>
        {course_data.map(function (item) {
          return (
            <p className="text-blue-900 font-normal p-2  border border-transparent hover:cursor-pointer hover:bg-blue-950 hover:text-white  hover:border rounded-md">
              {item}
            </p>
          );
        })}
      ...
      <div className="flex flex-col gap-3 md:w-[20%]">
        <h1 className="text-red-600 font-bold border border-b-2 hover:cursor-pointer border-transparent p-1 hover:border-b-blue-900">Procedure</h1>
      ...
      <div className="flex flex-col gap-3 md:w-[20%]">
        <h1 className="text-red-600 font-bold border border-b-2 hover:cursor-pointer border-transparent p-1 hover:border-b-blue-900">Legal</h1>
        <p className="text-blue-900 font-normal p-2  border border-transparent hover:bg-blue-950 hover:cursor-pointer hover:text-white  hover:border rounded-md">
          Terms and Conditions
        </p>
      </div>
      <div className="flex flex-col gap-3 md:w-[20%]">
        <h1 className="text-red-600 font-bold border border-b-2 hover:cursor-pointer border-transparent p-1 hover:border-b-blue-900">Follow Us</h1>
        ...
        <p className='text-blue-900 font-normal hover:text-red-600 hover:cursor-pointer'>Email: info@icvte.com</p>
        <p className='text-blue-900 font-normal  hover:text-red-600 hover:cursor-pointer'>Phone: +91 9789832552</p>
      </div>
