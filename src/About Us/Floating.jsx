    ...
    <div className="relative h-[500px] bg-[#030852] overflow-hidden flex justify-center items-center p-1 md:h-[400px] ">
      ...
      <div className="flex flex-col gap-4 text-center z-10 m-1">
        ...
        <div className='flex flex-col items-center gap-4 md:flex-row md:justify-center'>
          <p className='font-bold text-normal transition-transform duration-300 hover:scale-105 hover:cursor-pointer text-white p-4 bg-[#353A76] w-[60%] rounded-lg md:text-xl md:w-[30%]  '>Mr.Bala Murugan</p>
          <p className='font-bold text-normal transition-transform duration-300 hover:scale-105 hover:cursor-pointer text-white p-4 bg-[#353A76] w-[60%] rounded-lg md:text-xl md:w-[30%]'>Mr.Saravanan</p>
        </div>
      </div>
