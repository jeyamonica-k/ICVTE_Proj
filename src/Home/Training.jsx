...
const values=[{
  ...
  return (
    <>
    <div className="flex flex-col items-start md:items-center mb-3">
      ...
      
   {
    values.map(function(data,index){
      return(
        <div className={`relative w-[300px] h-[400px] md:w-[500px] md:h-[600px] lg:w-[450px] lg:h-[400px] group overflow-hidden ${index=== 1 || index === 3 ? "mt-20":" "}`}>
    ...
    <p className="text-red-500 md:text-xl  md:p-3 md:m-3">{data.desc}</p>
    </div>
    </div>
      )
    })
