            ...
            return (
              <>
                ...
                >
                  ...
                  <span className="absolute top-0 right-0 bottom-0 left-[0] scale-x-0 -translate-x-full transition-transform duration-500  bg-white group-hover:-translate-x-0 group-hover:scale-x-100"></span>
                </div>
              </>
            );
          })}
