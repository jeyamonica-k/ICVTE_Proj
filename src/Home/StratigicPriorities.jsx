  ...
  return (
    <div ref={sectionRef}>
      ...
      <div className={`flex flex-col gap-4  xl:justify-center xl:items-center xl:w-[100%] `}>
        <h1 className=' text-3xl font-bold text-[#FFFFFF] xl:            k5xl inline-block relative' >Strategic Priorities</h1>
      ...
      <div className='flex flex-col  gap-2 xl:p-6 xl:m-9 '>
        <div  className='flex flex-col items-center gap-4 border-b-3 border-b-[#FFFFFF]  p-2'>
          ...
          <p className='text-normal text-gray-300 font-light xl:text-xl'>We believe that education should be a right, not a privilege. ICVTE offers special programs for marginalized communities, including women, rural populations, and differently-abled individuals. Our goal is to make vocational education accessible to all, regardless of socio-economic background</p>
        </div>
        <div  className='flex flex-col items-center gap-2 border-b-3 border-b-[#FFFFFF]  p-2 '>
          ...
          <p className='text-normal text-gray-300 font-light xl:text-xl'>ICVTE is committed to promoting environmentally responsible practices. We incorporate green skills and sustainable technologies into our curricula, preparing students to be conscious and responsible members of the workforce</p>
        </div>
