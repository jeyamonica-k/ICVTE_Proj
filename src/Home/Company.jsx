...
function Company() {
  ...
  return (
    <div ref={sectionRef}  >
      {/* main div */}
      <div className={`flex flex-col gap-2 p-5 m-5 lg:mx-18 lg:my-12 transform transition-all duration-1000 ease-in-out  ${
      isVisible ? "translate-x-0 opacity-100" : "translate-x-full opacity-0"} `}>
        ...
        <div className='flex flex-col gap-2 p-2.5 mt-3'>
          <h1 className='text-red-600 font-medium text-xl md:text-2xl'>Our Mission At ICVTE:</h1>
          <p className='text-blue-950 text-justify md:text-xl'>our mission is to bridge the gap between education and employment by offering comprehensive vocational training programs. We aim too.</p>
        </div>
        <div className='flex flex-col gap-2 xl:flex-row'>
          {
            ...
            <h1 className='font-medium text-xl md:text-2xl'>{data.heading}</h1>
